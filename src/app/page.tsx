...
export default function Home() {
  return (
    <div className="max-w-[1200px] mx-auto px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
      {/* HERO */}
      <div className="relative min-h-[520px] overflow-hidden rounded-2xl bg-green p-5 sm:p-8 md:min-h-[620px] md:p-16 lg:p-20 flex items-end mb-6 sm:mb-8">
        <video
        ...
        <div className="relative z-10 max-w-[620px] text-center md:text-left">
          <div className="hero-lazy hero-lazy-1 bg-yellow/20 border border-yellow/45 text-yellow px-3 py-1.5 sm:px-4 rounded-full text-[0.7rem] sm:text-xs font-semibold inline-block mb-5 sm:mb-6 tracking-wide">
            Season 2026 • Now Harvesting
          </div>
          <h1 className="hero-lazy hero-lazy-2 text-4xl sm:text-5xl lg:text-[3.5rem] text-white leading-[1.08] mb-5 font-bold font-serif">
            Pure Mangoes,<br />
            <em className="text-yellow not-italic">Directly from</em><br />
            Our Orchard
          </h1>
          <p className="hero-lazy hero-lazy-3 text-white/85 text-base sm:text-lg leading-relaxed mb-7 sm:mb-8 font-light">
          ...
          <div className="hero-lazy hero-lazy-4 flex flex-wrap gap-4 justify-center md:justify-start">
            <Link href="/shop" className="bg-yellow text-dark rounded-full px-6 py-3 sm:px-8 text-sm font-semibold transition-all hover:bg-[#ffd15c] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(245,166,35,0.4)]">
              Shop Mangoes
            </Link>
            <Link href="/contact" className="bg-yellow/10 text-yellow border-2 border-yellow/45 rounded-full px-6 py-3 sm:px-8 text-sm font-semibold transition-all hover:border-yellow hover:bg-yellow hover:text-dark">
              Ask Availability
            </Link>
          </div>
        </div>
      ...
      {/* TRUST STRIP */}
      <div className="bg-white rounded-2xl p-4 sm:p-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 border border-border mb-12 sm:mb-16 text-center">
      ...
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl sm:text-4xl text-dark mb-2 font-serif">This Season&apos;s Finest</h2>
